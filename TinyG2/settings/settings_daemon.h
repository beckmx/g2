 ...
 */
 ...
 #ifndef SETTINGS_daemon_H_ONCE
 #define SETTINGS_daemon_H_ONCE
...
#define INIT_MESSAGE "Initializing configs to Bantam Tools daemon settings"
...
#define MOTOR_POWER_LEVEL_XY        0.75  // default motor power level 0.00 - 1.00 (ARM only)
...
#define B_TRAVEL_MIN          -1										// min/max the same means infinite, no limit
...
// enable the detection of a jumper on BMAX
#define B_SWITCH_MODE_MAX     SW_MODE_CUSTOM
...
#define C_TRAVEL_MIN          -1										// min/max the same means infinite, no limit
...
// enable the detection of a jumper on CMAX
#define C_SWITCH_MODE_MAX     SW_MODE_CUSTOM
