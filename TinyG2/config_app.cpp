...
const cfgItem_t cfgArray[] PROGMEM = {
	...
	{ "",   "safe",_f0, 0, cm_print_safe, cm_get_safe, set_nul,(float *)&cs.null, 0 },          // interlock status
...
//	{ "",   "ms",  _fip, 0, cm_print_ms,  get_flt, set_flt, (float *)&cm.estd_segment_usec,	NOM_SEGMENT_USEC },
	...
	{ "","s273", _f0, 3, spi2_cmd73_print, get_flt, spi2_cmd73_set,(float *)&spi2_esc_current },		// read current esc value
